package com.eso.crudwithoutroom;
...
import com.eso.crudwithoutroom.adapter.ContactsAdapter;
import com.eso.crudwithoutroom.databinding.ActivityMainBinding;
import com.eso.crudwithoutroom.db.ContactAppDatabase;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        recyclerView = activityMainBinding.recyclerViewContacts;
    ...
    public void addAndEditContacts(final boolean isUpdate, final Contact contact, final int position) {
        ...
        @SuppressLint("InflateParams") View view = layoutInflaterAndroid.inflate(R.layout.layout_add_contact, null);
    ...
    private void createContact(String name, String email) {
        new CreateContact().execute(new Contact(0,name,email));
    }
    ...
    public class DeleteContact extends AsyncTask<Contact,Void,Void> {
        @Override
        protected Void doInBackground(Contact... contacts) {
    ...
    public class CreateContact extends AsyncTask<Contact,Void,Void> {
